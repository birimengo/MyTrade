...
const Wholesaler = () => {
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-2 h-[500px]">
        <div className="flex justify-between items-center mb-6">
          <h2 className="text-xl font-bold text-gray-800 dark:text-white">Wholesaler Directory</h2>
          <div className="w-32 h-8 bg-gray-200 dark:bg-gray-700 rounded-md animate-pulse"></div>
        </div>
        <div className="flex flex-col items-center justify-center py-12">
          <div className="relative">
            <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-blue-500"></div>
            <div className="absolute top-0 left-0 rounded-full h-12 w-12 border-t-2 border-blue-300 animate-pulse"></div>
          </div>
          <span className="mt-4 text-sm font-medium text-gray-600 dark:text-gray-300">Loading wholesalers...</span>
  ...
  if (error) {
    return (
      <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-2 h-[500px]">
        <h2 className="text-xl font-bold text-gray-800 dark:text-white mb-6">Wholesaler Directory</h2>
  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mt-2 h-[500px] flex flex-col">
      {/* Header Section */}
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-6">
        ...
        {user?.productCategory && (
          <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-gradient-to-r from-blue-100 to-blue-50 text-blue-800 dark:from-blue-900/30 dark:to-blue-800/30 dark:text-blue-300 mt-2 lg:mt-0">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3 mb-6 p-4 bg-gray-50 rounded-lg dark:bg-gray-700/50">
          <div className="relative flex-1">
            ...
            <input
              ...
              className="pl-10 pr-4 py-2 w-full border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-600 dark:border-gray-500 dark:text-white"
            />
          </div>
      ...
      {/* Content Section - This section will now have a scrollbar */}
      <div className="flex-1 overflow-y-auto">
        {!user?.productCategory ? (
          <div className="text-center py-12">
            ...
            <button className="mt-4 bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200">
              Update Profile
            </button>
          </div>
          ...
          <>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-5">
              {filteredWholesalers.map(wholesaler => (
                <div key={wholesaler._id} className="border border-gray-200 rounded-xl p-5 transition-all duration-300 hover:shadow-lg hover:border-blue-100 dark:border-gray-700 dark:hover:border-blue-800/50 dark:bg-gray-800/50 group">
                  {/* Header with status */}
                  <div className="flex items-start justify-between mb-4">
                    ...
                    <div className="flex items-center space-x-2">
                      {wholesaler.isOnline ? (
                        ...
                        <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium bg-gray text-gray-800 dark:bg-gray-700 dark:text-gray-300">
                  ...
                  <div className="space-y-3 mb-4">
                    ...
                    <div className="flex items-center text-sm text-gray-600 dark:text400">
                      <svg className="w-4 h-4 mr-3 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    {wholesaler.address && (
                      <div className="flex items-start text-sm text-gray-600 dark:text-gray-400">
                        ...
                        <span className="flex-1">{wholesaler.address}, {wholesaler.city}</span>
                      </div>
                    )}
                  </div>
                  ...
                  <div className="pt-4 border-t border-gray-100 dark:border-gray-700 flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
                    ...
                    <div className="flex space-x-2">
                      ...
                      <button
                        ...
                        className="flex-1 bg-blue-600 hover:bg-blue-700 text-white px-3 py-1.5 rounded-lg text-xs font-medium transition-colors duration-200 flex items-center justify-center"
                      >
                        <svg className="w-3 h-3 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24">
