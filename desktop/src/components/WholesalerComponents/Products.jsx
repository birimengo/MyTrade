...
const Products = ({ isElectron, isOnline, onSync, syncStatus }) => {
  ...
  // Handle navigation state - removed useLocation dependency
  useEffect(() => {
  ...
  // Manual state setter for external components (like ManualStock)
  const setProductAction = (action, productId = null, productData = null) => {
